...
🔹 **AI-Powered Document Analysis System** — An intelligent document assistant with real-time context-aware Q&A, citation extraction, automated summarization, and text simplification, with multi-format support and a responsive chat interface.

🔹 **RENT — Property Rental Platform** — A scalable REST API backend (Node.js, Express, PostgreSQL) with secure authentication, listing management, and efficient apartment/room search.
